                      ...
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          @foreach ($order as $getData)
                            ...
                            <td>{{ $loop->iteration }}</td>
                              ...
                              <td>
                              {{ $getData ->supir_name }} <br> {{ $getData ->supir_telpon }}
                              </td>                        
                              ...
                              <td>
                              <form action="{{ route('aorder.destroy', $getData->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('aorder.edit', $getData->id) }}" type="button" class="btn btn-info" style="font-size: 10px; padding: 10px; margin: 10px;">Edit Order</a>
                                <button type="submit" class="btn btn-danger" style="font-size: 10px; padding: 10px; margin: 10px;">Delete</button>
                              </form>
                              </td>
                            </tr>
                            @endforeach
