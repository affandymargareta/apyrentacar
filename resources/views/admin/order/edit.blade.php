          ...
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 my-3">
            <div class="projects mb-4">
              <div class="projects-inner">
                  ...
                  <form method="post" action="{{ route('aorder.update', $order->id) }}" enctype="multipart/form-data">               
                    @method('PUT')
                    @csrf
                  ...
                  <div class="form-group" style="color: #fff;">
                    <label >Jenis</label>
                    <input type="text" class="form-control" name="jenis" value="{{ $order->jenis }}">
                    <small class="form-text text-muted">We'll never share your Jenis with anyone else.</small>
                  </div> 
                  
                  <div class="form-group" style="color: #fff;">
                    <label >Bagasi</label>
                    <input type="text" class="form-control" name="bagasi" value="{{ $order->bagasi }}">
                    <small class="form-text text-muted">We'll never share your Bagasi with anyone else.</small>
                  </div>
                  <div class="form-group" style="color: #fff;">
                    <label >Kursi</label>
                    <input type="text" class="form-control" name="kursi" value="{{ $order->kursi }}">
                  ...
                  <div class="form-group" style="color: #fff;">
                    <label >Stock</label>
                    <input type="text" class="form-control" name="stock" value="{{ $order->stock }}">
                    <small class="form-text text-muted">We'll never share your Price with anyone else.</small>
                  </div>
