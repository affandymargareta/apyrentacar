              ...
              <div class="projects-inner">
                  ...
                  <!-- Modal -->
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <form method="post" action="{{ route('sellerpayment.store') }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                      ...
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          @foreach ($payment as $getData)
                            ...
                            <td>{{ $loop->iteration }}</td>
                              ...
                              <td>															
                                  <a  href="">
                                      <img class="img-fluid" src="{{ asset($getData->image) }}" width="200px;" height ="200px;" alt="image" />
                                  </a>
                              </td>
                              ...
                              <td>
                              <form action="{{ route('sellerpayment.destroy', $getData->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('sellerpayment.edit', $getData->id) }}" type="button" class="btn btn-info">Edit Product</a>
