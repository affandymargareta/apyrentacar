              ...
              <div class="projects-inner">
                  ...
                  <!-- Modal -->
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <form method="post" action="{{ route('productcar.store') }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <div class="form-group" style="color: #000;">
                                <label >Product Car Name</label>
                                <select name="productname_id" style="background: #f8f9fa !important; color: #0044cc !important;" class="rounded-pill form-control">
                                    <option value="">Pilih</option>
                                    @foreach ($names as $row)
                                    <option value="{{ $row->id }}" {{ old('productname_id') == $row->id ? 'selected':'' }}>{{ $row->name }}</option>
                                    @endforeach
                                </select>  
                              ...
                              <div class="form-group" style="color: #000;">
                                <label >Member</label>
                                <select name="seller_id" style="background: #f8f9fa !important; color: #0044cc !important;" class="rounded-pill form-control">
                                    <option value="">Pilih</option>
                  ...
                  <div class="container" style="color: #fff;">
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          <tbody>
                          @foreach ($car as $getData)
                            <tr>
                            <td>{{ $loop->iteration }}</td>

                              <td>
                              {{ $getData ->productname_id }} <br> {{ $getData ->productName->name }}
                              </td>
                              <td>
                                {{ $getData->seller_id }}  <br> {{ $getData->seller->name }} 
                              </td>
                             
                             
                              <td>
                              <form action="{{ route('productcar.destroy', $getData->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('productcar.edit', $getData->id) }}" type="button" class="btn btn-info">Edit Product</a>
