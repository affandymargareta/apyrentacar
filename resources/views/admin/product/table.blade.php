                      ...
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          @foreach ($product as $getData)
                            ...
                            <td>{{ $loop->iteration }}</td>
                              ...
                              <td>															
                                  <a  href="">
                                      <img class="img-fluid" src="{{ asset($getData->productImages->image) }}" width="200px;" height ="200px;" alt="image" />
                                  </a>
                              </td>
                              <td>
                                  {{ $getData ->jenis }}
                              ...
                              <td>
                              <form action="{{ route('product.destroy', $getData->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('product.edit', $getData->id) }}" type="button" class="btn btn-info">Edit Product</a>
