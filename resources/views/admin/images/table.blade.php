                      ...
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          @foreach ($images as $getData)
                            ...
                            <td>{{ $loop->iteration }}</td>
                              ...
                              <td>
                              <form action="{{ route('productimage.destroy', $getData->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('productimage.edit', $getData->id) }}" type="button" class="btn btn-info">Edit Product</a>
