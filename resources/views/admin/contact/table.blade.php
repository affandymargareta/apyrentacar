                      ...
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          @foreach ($contact as $getData)
                            ...
                            <td>{{ $loop->iteration }}</td>
                              ...
                              <td>
                                <form action="{{ route('contact.destroy', $getData->id) }}" method="post">
                                  @csrf
                                  @method('DELETE')
                                  <a href="{{ route('contact.edit', $getData->id) }}" type="button" class="btn btn-info">Edit Product</a>
