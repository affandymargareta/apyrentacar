              ...
              <div class="projects-inner">
                  ...
                  <!-- Modal -->
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <form method="post" action="{{ route('productname.store') }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                      ...
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          @foreach ($names as $getData)
                            ...
                            <td>{{ $loop->iteration }}</td>
                              ...
                              <td>
                              <form action="{{ route('productname.destroy', $getData->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('productname.edit', $getData->id) }}" type="button" class="btn btn-info">Edit Product</a>
