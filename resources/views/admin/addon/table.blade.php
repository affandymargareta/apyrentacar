                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <form method="post" action="{{ route('addon.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="form-group" style="color: #fff;">
                            <label >Price</label>
                            <input type="text" class="form-control" name="addon_price" value="{{ old('addon_price') }}">
                      ...
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          @foreach ($addon as $getData)
                            ...
                            <td>{{ $loop->iteration }}</td>
                              ...
                              <td>
                              <form action="{{ route('addon.destroy', $getData->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('addon.edit', $getData->id) }}" type="button" class="btn btn-info">Edit Product</a>
