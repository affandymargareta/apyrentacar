          ...
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 my-3">
            <div class="projects mb-4">
              <div class="projects-inner">
                  ...
                  <form method="post" action="{{ route('addon.update', $addon->id) }}" enctype="multipart/form-data">               
                    @method('PUT')
                    @csrf
                  <div class="form-group" style="color: #fff;">
                    ...
                    <select name="product_id" style="background: #f8f9fa !important; color: #0044cc !important;" class="rounded-pill form-control">
                        ...
                        <option value="{{ $row->id }}" {{ old('product_id') == $row->id ? 'selected':'' }}>{{ $row->productName->name }}</option>
                        @endforeach
                    </select>  
                  ...
                  <div class="form-group" style="color: #fff;">
                    <label >Price</label>
                    <input type="text" class="form-control" name="addon_price" value="{{ $addon->addon_price }}">
