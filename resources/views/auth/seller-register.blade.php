          ...
          <div class="card-body px-4 py-5 px-md-5">
                <div class="text-center">
                  <img src="{{ asset('images/apyrentacars.png') }}"
                    ...
                    <h4 class="mt-2 mb-1 pb-1">Members</h4>
                </div>
            ...
            <div data-mdb-input-init class="form-outline mb-2">
                ...
                <input type="text" name="address" class="form-control" value="{{ old('address') }}" style="border: 2px solid #673AB7;" />
            ...
            <div data-mdb-input-init class="form-outline mb-2">
                ...
                <input type="date" name="tanggal" class="form-control" value="{{ old('tanggal') }}" style="border: 2px solid #673AB7;" />
                <small class="form-text text-muted">We'll never share your Phone with anyone else.</small>
              </div>
            ...
            <div data-mdb-input-init class="form-outline mb-2">
                <!-- <label class="form-label" for="form3Example3" style="color: hsl(218, 81%, 95%)">Email</label> -->
                <label class="form-label" style="color: #000">City</label>
                <input type="text" name="city" class="form-control" value="{{ old('city') }}" style="border: 2px solid #673AB7;" />
                <small class="form-text text-muted">We'll never share your City with anyone else.</small>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col">
                  <!-- Simple link -->
                  <a href="{{ route('members.login') }}" style="color: #000">Already registered?</a>
                </div>
              </div>
