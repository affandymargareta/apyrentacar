        ...
        <div class="card bg-glass">
          <div class="card-body px-4 py-5 px-md-5">
                <div class="text-center">
                  ...
                  <h4 class="mt-2 mb-1 pb-1">Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.</h4>
                  <h4 class="mt-2 mb-1 pb-1">Members</h4>

                </div>
            <form method="POST" action="{{ route('members.password.email') }}">
                @csrf
              ...
              <div class="d-grid gap-2">
                <button type="submit" class="btn" style="background-color: #6747c7; color :#fff;">Email Password Reset Link</button>
              </div>
