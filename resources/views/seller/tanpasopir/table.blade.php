              ...
              <div class="projects-inner">
                  ...
                  <!-- Modal -->
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <form method="post" action="{{ route('tanpasopirm.store') }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                      ...
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          @foreach ($product as $getData)
                            <tr>
                              ...
                              <form action="{{ route('tanpasopirm.destroy', $getData->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <a href="{{ route('tanpasopirm.edit', $getData->id) }}" type="button" class="btn btn-info">Edit Product</a>
