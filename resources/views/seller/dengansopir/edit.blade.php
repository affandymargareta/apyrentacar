          ...
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 my-3">
            <div class="projects mb-4">
              <div class="projects-inner">
                  ...
                  <form method="post" action="{{ route('dengansopirm.update', $product->id) }}" enctype="multipart/form-data">               
                    @method('PUT')
                    @csrf
                  ...
                  <div class="form-group" style="color: #000;">
                      ...
                      <select name="name" style="background: #f8f9fa !important; color: #0044cc !important;" class="rounded-pill form-control">
                          <option value="">Pilih</option>
                            <option value="{{ $product->productName->id }}" {{ old('name') == $product->productName->id ? 'selected':'' }}>{{ $product->productName->name }}</option>
                      </select>  
