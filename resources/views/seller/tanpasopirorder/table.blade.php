                      ...
                      <table id="example" class="table table-striped table-bordered" style="color: #fff;">
                          ...
                          @foreach ($order as $getData)
                            <tr>
                              ...
                              <td>{{ date("D, d F Y", strtotime($getData ->created_at)) }}</td>
                              ...
                              <td>
                                  {{ date("D, d F Y", strtotime($getData ->akhir)) }}
                              </td>
                              <td>
                              {{ $getData ->jam_akhir }}
                              </td>
                              ...
                              <td>
                              <a href="{{ route('mtanpasopir.edit', $getData->id) }}" type="button" class="btn btn-info"  style="font-size: 10px;">Isi Data Plat</a>
                              <!-- <a href="" type="button" class="btn btn-info"  style="font-size: 10px;">Invoice</a> -->
