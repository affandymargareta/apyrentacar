...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="{{ route('dengansopirm.index') }}" style="color: #1fb2ca;">Product</a></li>
      <li><a href="{{ route('mdengansopir') }}" style="color: #1fb2ca;">Order</a></li>
    </ul>
...
<div class="container bootstrap snippets bootdeys">
  <div class="row">
        ...
        <a href="{{ route('mdengansopir.edit', $order->id) }}" class="btn btn-info"><i class="fa fa-envelope-o"></i> Isi Detail Sopir</a>
        <p class="lead marginbottom"></p>
			</div>
  ...
  <div class="col-sm-12">
                ...
                <td colspan="2">
                  <div style="font-size: 20px; font-weight: bold; padding: 10px">Detail Pesanan</div>
			        ...
			        <tr>
			          ...
			          <td style="width:50%" style="font-size: 20px; padding: 25px">{{ $order->dengansopir->productName->name }}</td>
			        </tr>
              <tr>
      ...
      <div class="row">
            ...
            <tr> 
              ...
              @if ($order->jemput_id > 0)
                @if ($order->jemput_id != $order->dengansopir->wilayah)
              ...
              @if ($order->kembali_id > 0)
                @if ($order->kembali_id != $order->dengansopir->wilayah)
      ...
      <h4 style="margin-left: 20px">Pembelian Online</h4>
            ...
            <tr>
			          ...
			          <td style=" border-color: #FFC107;">{{ $order->dengansopir->productName->name }}</td>
			          <td style=" border-color: #FFC107;">IDR {{ $order->dengansopir->price }}</td>
			          <td style=" border-color: #FFC107;">{{ $order->durasi }}</td>
			          <td style=" border-color: #FFC107;">IDR {{ $order->dengansopir->price * $order->durasi }}</td>
			        </tr>
