    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="car-list">
	    				<table class="table">
								  ...
								  <td class="product-name2">
									  ...
									  <div class="price-rate">
										<h3>
											...
											<span class="subheading2">: Tanpa Sopir</span>
										</h3>
									</div>
									  <h3>Rental Mobil Tanpa Supir / Rent A Car Without Driver
									  </h3>
							...
							<td class="car-image"><div class="img" style="background-image:url({{ asset($item['lowest_priced_product']->productImages->image) }});"></div></td>
						        ...
						        <td class="product-name">
									...
									<div class="price-rate">
							        	<h3>
							        		<span class="subheading1"><span class="flaticon-pistons subheading2"></span class="">{{ $item['lowest_priced_product']->jenis }}</span>
							        	</h3>
							        </div>
									<div class="price-rate">
							        	<h3>
							        		<span class="subheading1"><span class="flaticon-car-seat subheading2"></span class="">{{ $item['lowest_priced_product']->bagasi }} Bag</span>
											<span class="subheading1"><span class="flaticon-backpack subheading2"></span class=""> {{ $item['lowest_priced_product']->kursi }} Seat</span>
							        	</h3>
									</div>
									<div class="price-rate">
							        	<h3>
							        		<!-- <span class="subheading3">Tanpa Sopir</span> -->
							        		<span class="subheading2">With Driver /{{ $item['lowest_priced_product']->stock }} Stock Providers Available</span>
							        	</h3>
						        	</div>
						        </td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td class="prices">
									<form action="{{route('searching1', $item['name_id'])}}" method="get" enctype="multipart/form-data">
									...
									<div class="price-rate">
										<h6>
											...
											<span class="num"> {{ number_format($item['lowest_priced_product']->price) }}</span>
