		...
		<table style="margin-bottom: 20px; margin-top: 10px; margin-left: 20px; margin-right: 20px;">
			...
			@if ($jemput_id > 0)
				...
				<tr>
					...
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">{{ $lokasi_jemput }} 
					<br></td>
				</tr>
				@else
				<tr>
			...
			@if ($kembali_id > 0)
				...
				<tr>
					...
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">{{ $lokasi_kembali }} 
					<br></td>
				</tr>
				@else
				<tr>
