...
<section class="ftco-section ftco-degree-bg">
	<div class="container">
		...
		<form method="post" action="{{ route('cartstore') }}" enctype="multipart/form-data">
			@method('POST')
			@csrf
									...
									<div class="panel-body">
										...
										<ul class="list-group" id="listItemOrder"  style="color : #000;">
											...
											<li class="list-group-item d-flex justify-content-between align-items-center" style="color : #000;">
												...
												<span id="rentalDasar" style="color : #000;">{{ formatUang($product->price) }}</span>
											</li>
...
<script>
	...
	function hitungTotal() {
		...
		let total = parseInt(rentalDasarPlusHari) + parseInt(zona1) + parseInt(zona2) + (parseInt(addonHari) * parseInt(addonPriceValue));
