...
<body>
	...
	<table id="tarif" style="margin-bottom: 15px; page-break-after: always">
		...
		<tr>
			...
			<td style=" border-color: #FFC107;">IDR {{ $product_price }}</td>
			<td style=" border-color: #FFC107;">IDR {{ $product_price * $hari }}</td>
		</tr>
			@if ($jemputPrice > 0)
				@if ($jemput_id != $product)
				<tr>
					...
					<td style=" border-color: #FFC107;">IDR {{ $jemputPrice * $hari }}</td>
				</tr>	
				@else
			...
			@if ($kembaliPrice > 0)
				...
				<tr>
					...
					<td style=" border-color: #FFC107;">IDR {{ $kembaliPrice  * $hari}}</td>
				</tr>
				@else
		...
		<tr>
			...
			<td style="border-color: #FFC107;"></td>
			<td style="border-color: #FFC107;"></td>
			<td style="font-weight: bold;  border-color: #FFC107;">IDR {{ $price }}</td>
		</tr>
	</table>
