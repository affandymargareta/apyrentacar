      ...
      <td>
		...
		<table style="margin-bottom: 20px; margin-top: 10px; margin-left: 20px; margin-right: 20px;">
			...
			<tr>
				<td colspan="2">
					<!-- <div style="font-size: 18px; padding-bottom: 5px; padding-left: 30px; padding-top: 30px;">Detail Rental</div> -->
					<div style="font-size: 20px; font-weight: bold; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Detail Plat</div>
				</td>
			</tr>
			<tr style="background: rgba(0, 0, 0, 0.03);">
				<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Series Mobil</td>
				<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">{{ $product_name }}</td>
			</tr>
			<tr>
				<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Plat Nomer</td>
				<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">[{{ $plat_nomer }}]
				<br></td>
			</tr>
