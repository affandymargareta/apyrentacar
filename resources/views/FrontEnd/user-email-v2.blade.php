      ...
      <td>
		...
		<table style="border: 1px solid #8e8e8e; margin: 20px;">
			<tr>
				<td colspan="2">
					...
					<div style="font-size: 20px; font-weight: bold; padding-bottom: 10px; padding-right: 30px; padding-left: 30px; padding-top: 5px; background: rgba(0, 0, 0, 0.03);">Dengan Supir</div>
				</td>
			</tr>
		...
		<table style="margin-bottom: 20px; margin-top: 10px; margin-left: 20px; margin-right: 20px;">
			...
			@if ($jemput_id > 0)
				...
				<tr>
					<td colspan="2">
						...
						<div style="font-size: 20px; font-weight: bold; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Detail Penjemputan </div>
					</td>
				</tr>
				<tr style="background: rgba(0, 0, 0, 0.03);">
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Tanggal & Waktu Penjemputan</td>
				...
				<tr>
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Lokasi Penjemputan</td>
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">{{ $lokasi_jemput }} : {{ $lokasi_jemput_lengkap }} 
					<br></td>
				</tr>
				@else
				<tr>
				...
				<tr>
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Lokasi Penjemputan</td>
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">{{ $lokasi_jemput }}, Free 
					<br></td>
				</tr>
				@endif
			@endif
			...
			@if ($kembali_id > 0)
				...
				<tr>
					<td colspan="2">
						...
						<div style="font-size: 20px; font-weight: bold; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Detail Pengantaran</div>
					</td>
				</tr>
				<tr style="background: rgba(0, 0, 0, 0.03);">
				...
				<tr>
					...
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">{{ $lokasi_kembali }} : {{ $lokasi_kembali_lengkap }} 
					<br></td>
				</tr>
				@else
				<tr>
				...
				<tr>
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Lokasi Pengantaran</td>
					<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">{{ $lokasi_kembali }}, Free
					<br></td>
				</tr>
			...
			<tr>
				<td colspan="2">
					<!-- <div style="font-size: 18px; padding-bottom: 5px; padding-left: 30px; padding-top: 30px;">Detail Rental</div> -->
					<div style="font-size: 20px; font-weight: bold; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Detail Supir</div>
				</td>
			</tr>
			<tr style="background: rgba(0, 0, 0, 0.03);">
				<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">Nama Supir</td>
				<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">{{ $supir_name }}</td>
			</tr>
			<tr>
				<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">No. Telepon</td>
				<td width="50%" style="font-size: 18px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px;">[{{ $supir_telpon }}]
				<br></td>
			</tr>
						
		</table>
		<h4 style="margin: 0px 20px; padding-bottom: 5px; padding-top: 10px;">Kontak Penyedia Rental </h4>

		<table style="border: 1px solid #8e8e8e; margin: 20px;">
			<tr style="background: rgba(0, 0, 0, 0.03);">
				<td width="50%" style="font-size: 20px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px; padding-right: 30px;">Nama Supplier</td>
				<td width="50%" style="font-size: 20px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px; padding-right: 30px;">{{ $seller_name }}</td>
			</tr>
			<tr>
				<td width="50%" style="font-size: 20px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px; padding-right: 30px;">No. Telepon</td>
				<td width="50%" style="font-size: 20px;padding-bottom: 10px; padding-left: 30px; padding-top: 5px; padding-right: 30px;">[{{ $seller_telpon }}]</td>
			</tr>
			<tr>
				<td width="50%" style="font-size: 20px; padding-bottom: 10px; padding-left: 30px; padding-top: 5px; padding-right: 30px;">Email</td>
				<td width="50%" style="font-size: 20px;padding-bottom: 10px; padding-left: 30px; padding-top: 5px; padding-right: 30px;">[{{ $seller_email }}]</td>
			</tr>				
		</table>
		<table border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="white" width="650">
		<tr>
		...
		<tr>
            <td>
              <a href="{{ route('user.dashboard') }}"  style="background-color:#36b445; color:white; padding:15px 97px; outline: none; display: block; margin: auto; border-radius: 31px;
                font-weight: bold; margin-top: 25px; margin-bottom: 25px; border: none; text-align: center; ">Dashboard</a>
            </td>
          </tr>
		  <tr>
            <td style="text-align: left;">
              <p style=" margin: 0px 30px; padding-bottom: 5px; line-height: 2; font-size: 15px;">Halo {{ $customer_name }}.
              </p>
